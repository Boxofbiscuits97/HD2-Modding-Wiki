...
![color-texture](/images/textures/pilot_mcor_m_helmet_dmp_a_urb_col.png)

### Normal 
RGBA texture that gives detail to your model. It’s what takes a flat plane and gives it bumps and ridges.

![normal-opengl-texture](/images/textures/pilot_mcor_m_helmet_dmp_a_urb_n_OpenGL.png)

![normal-directx-texture](/images/textures/pilot_mcor_m_helmet_dmp_a_urb_n_DirectX.png)
...
![green-channel-selected](/images/textures/green-channel-selected.png)
:::
...
![emissive-texture](/images/textures/pilot_mcor_m_helmet_dmp_a_urb_e.png)
...
![metallic-texture](/images/textures/pilot_mcor_m_helmet_dmp_a_urb_m.png)
...
![roughness-texture](/images/textures/pilot_mcor_m_helmet_dmp_a_urb_r.png)
...
![rough-metal-table](/images/textures/rough-metal-table-edit.png)
:::
...
![ao-texture](/images/textures/Minotaur_Helmet_HD_ao.png)
...
![pbr-texture](/images/textures/pilot_mcor_m_helmet_dmp_a_urb_pbr.png)