...
![discord-preview](/images/sdk-functions/discord.png)

A direct link to the HD2 Community Modding Discord.

### Archive IDs

![archive-ids-preview](/images/sdk-functions/archive-ids.png)

A direct link to the spreadsheet listing the archives for currently found game assets.

### GitHub SDK Link

![github-preview](/images/sdk-functions/github.png)

GitHub to the HD2 SDK releases.

### Star Icon

![star-icon-preview](/images/sdk-functions/star-icon.png)
...
![found-archives-preview](/images/sdk-functions/found-archives.png)

### Unload Patches

![unload-patches-preview](/images/sdk-functions/unload-patches.png)

Unloads all patches currently loaded in the SDK, including the `base archive`.

### Archives

![archives-preview](/images/sdk-functions/archives.png)

Foldout menu displaying all archives currently loaded in the SDK.

### Manually Load Archives

![manually-load-archives-preview](/images/sdk-functions/manually-load-archives.png)

Search the `data` folder for an archive to load into the SDK.

### New Patch

![new-patch-preview](/images/sdk-functions/new-patch.png)

Makes a new patch in the SDK. Will automatically load the `base archive` if it has not been loaded yet.

### Write Patch

![write-patch-preview](/images/sdk-functions/write-patch.png)

Creates a patch set in the `data` folder from the current modified objects in the SDK.

### Export Patch

![export-patch-preview](/images/sdk-functions/export-patch.png)
...
![current-modified-preview](/images/sdk-functions/current-modified.png)

### Save

![save-preview](/images/sdk-functions/save.png)

Saves selected object into the current patch set.

### Import

![import-preview](/images/sdk-functions/import.png)

Imports selected object into the Blender scene.

### Add to Patch

![add-to-patch-preview](/images/sdk-functions/add-to-patch.png)

Adds selected object to patch

### Remove from Patch

![removes-from-patch-preview](/images/sdk-functions/remove-from-patch.png)
...
![show-material-editor-preview](/images/sdk-functions/show-material-editor.png)
...
![right-click-mesh-preview](/images/sdk-functions/right-click-mesh.png)
...
![right-click-menu-preview](/images/sdk-functions/right-click-menu.png)
