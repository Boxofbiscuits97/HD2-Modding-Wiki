...
![special-tools-preview](/images/sdk-settings/special-tools.png)
...
![bulk-load-preview](/images/sdk-settings/bulk-load.png)
...
![search-by-entry-id-preview](/images/sdk-settings/search-by-entry-id.png)

Put all numerical IDs and HexIDs of the objects you want to find the archives for into a .txt file.

![search-by-entry-id2-preview](/images/sdk-settings/search-by-entry-id2.png)
...
![search-by-entry-id3-preview](/images/sdk-settings/search-by-entry-id3.png)