...
![Player Avatar](/images/animation/player-avatar.png)
...
:::
![Player Archive](/images/animation/player-archive.png)
...
![Import Animation](/images/animation/import-animation.png)

You should see it starting to play and loop immediately.
![Player Salute Gif](/images/animation/player-salute.gif)
...
![Pose Mode](/images/animation/pose-mode.png)
...
![Save Animation](/images/animation/save-animation.png)
